package com.fabrika.pampaza.postDetail.ui.adapter
...
class MyCommentAdapter(var activity: PostDetailActivity) : RecyclerView.Adapter<MyCommentAdapter.MyPostAdapterViewHolder>() {
